...
# -------------------------------
with tab6:
    st.subheader("SQL Queries (Text Only)")
    ...
    try:
        ...
        # Display the queries as formatted SQL code
        st.code(sql_queries, language="sql")

        st.info("Queries are displayed for reference only. They are not executed in this dashboard.")

    except FileNotFoundError:
        st.error("⚠️ index.sql file not found. Please place it in the project directory.")
